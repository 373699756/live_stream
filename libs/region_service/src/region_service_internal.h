#ifndef LIVE_STREAM_REGION_SERVICE_SRC_REGION_SERVICE_INTERNAL_H_
#define LIVE_STREAM_REGION_SERVICE_SRC_REGION_SERVICE_INTERNAL_H_
...
public:
    explicit RegionServiceImpl(const RegionServiceOptions &service_options);
...
#endif  // LIVE_STREAM_REGION_SERVICE_SRC_REGION_SERVICE_INTERNAL_H_
