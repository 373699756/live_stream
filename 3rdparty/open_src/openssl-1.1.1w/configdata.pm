...
our %config = (
  ...
  openssldir => "/home/c/linux/hisi/live_stream/3rdparty/src/openssl-1.1.1w/install/ssl",
  options => "--cross-compile-prefix=arm-himix200-linux- --prefix=/home/c/linux/hisi/live_stream/3rdparty/src/openssl-1.1.1w/install --openssldir=/home/c/linux/hisi/live_stream/3rdparty/src/openssl-1.1.1w/install/ssl no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-ui-console no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.30.0",
  perlargv => [ "linux-armv4", "no-shared", "no-asm", "no-tests", "no-ui-console", "--cross-compile-prefix=arm-himix200-linux-", "--prefix=/home/c/linux/hisi/live_stream/3rdparty/src/openssl-1.1.1w/install", "--openssldir=/home/c/linux/hisi/live_stream/3rdparty/src/openssl-1.1.1w/install/ssl" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/c/linux/hisi/live_stream/3rdparty/src/openssl-1.1.1w/install",
  processor => "",
