...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/home/cp/cross_compile_tool/arm-himix200-linux/x86-arm/arm-himix200-linux/bin/arm-himix200-linux-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_TESTS", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UI_CONSOLE", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "/home/cp/Public/hisi/live_stream/3rdparty/open_src/openssl-1.1.1w/install/ssl",
  options => "--cross-compile-prefix=/home/cp/cross_compile_tool/arm-himix200-linux/x86-arm/arm-himix200-linux/bin/arm-himix200-linux- --prefix=/home/cp/Public/hisi/live_stream/3rdparty/open_src/openssl-1.1.1w/install --openssldir=/home/cp/Public/hisi/live_stream/3rdparty/open_src/openssl-1.1.1w/install/ssl no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-ui-console no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "linux-armv4", "no-shared", "no-asm", "no-tests", "no-ui-console", "--cross-compile-prefix=/home/cp/cross_compile_tool/arm-himix200-linux/x86-arm/arm-himix200-linux/bin/arm-himix200-linux-", "--prefix=/home/cp/Public/hisi/live_stream/3rdparty/open_src/openssl-1.1.1w/install", "--openssldir=/home/cp/Public/hisi/live_stream/3rdparty/open_src/openssl-1.1.1w/install/ssl" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/cp/Public/hisi/live_stream/3rdparty/open_src/openssl-1.1.1w/install",
  processor => "",
