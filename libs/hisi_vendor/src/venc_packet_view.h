#ifndef LIVE_STREAM_HISI_VENDOR_SRC_VENC_PACKET_VIEW_H_
#define LIVE_STREAM_HISI_VENDOR_SRC_VENC_PACKET_VIEW_H_
...
#endif  // LIVE_STREAM_HISI_VENDOR_SRC_VENC_PACKET_VIEW_H_
