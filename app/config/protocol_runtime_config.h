#ifndef LIVE_STREAM_APP_CONFIG_PROTOCOL_RUNTIME_CONFIG_H_
#define LIVE_STREAM_APP_CONFIG_PROTOCOL_RUNTIME_CONFIG_H_
...
#endif  // LIVE_STREAM_APP_CONFIG_PROTOCOL_RUNTIME_CONFIG_H_
