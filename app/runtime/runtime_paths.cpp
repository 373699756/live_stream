...
ResolvedRuntimePaths BuildRuntimePaths(const char *config_dir) {
...
RuntimePaths ResolvedRuntimePaths::ToRuntimePaths() const {
    RuntimePaths paths;
...
RuntimeStartupOptions ResolveRuntimeStartupOptions(int argc, char **argv) {
    ...
    options.paths = BuildRuntimePaths(config_dir);
