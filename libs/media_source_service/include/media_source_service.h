#ifndef LIVE_STREAM_MEDIA_SOURCE_SERVICE_MEDIA_SOURCE_SERVICE_H_
#define LIVE_STREAM_MEDIA_SOURCE_SERVICE_MEDIA_SOURCE_SERVICE_H_
...
#endif  // LIVE_STREAM_MEDIA_SOURCE_SERVICE_MEDIA_SOURCE_SERVICE_H_
