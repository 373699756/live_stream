#ifndef LIVE_STREAM_APP_PLATFORM_LINUX_LINUX_PLATFORM_COMMON_H_
#define LIVE_STREAM_APP_PLATFORM_LINUX_LINUX_PLATFORM_COMMON_H_
...
#endif  // LIVE_STREAM_APP_PLATFORM_LINUX_LINUX_PLATFORM_COMMON_H_
