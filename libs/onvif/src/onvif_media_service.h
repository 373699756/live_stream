#ifndef LIVE_STREAM_ONVIF_SERVICE_SRC_ONVIF_MEDIA_SERVICE_H_
#define LIVE_STREAM_ONVIF_SERVICE_SRC_ONVIF_MEDIA_SERVICE_H_
...
#endif  // LIVE_STREAM_ONVIF_SERVICE_SRC_ONVIF_MEDIA_SERVICE_H_
