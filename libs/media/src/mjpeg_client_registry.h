#ifndef LIVE_STREAM_MEDIA_SRC_MJPEG_CLIENT_REGISTRY_H_
#define LIVE_STREAM_MEDIA_SRC_MJPEG_CLIENT_REGISTRY_H_
...
#endif  // LIVE_STREAM_MEDIA_SRC_MJPEG_CLIENT_REGISTRY_H_
