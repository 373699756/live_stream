...
PIXEL_FORMAT_E ToHiPixelFormat(PixelFormat format) {
  switch (format) {
    case PixelFormat::kArgb1555: return PIXEL_FORMAT_ARGB_1555;
    case PixelFormat::kArgb4444: return PIXEL_FORMAT_ARGB_4444;
    case PixelFormat::kArgb8888: return PIXEL_FORMAT_ARGB_8888;
    case PixelFormat::kArgb2Bpp: return PIXEL_FORMAT_ARGB_2BPP;
  }
...
RGN_TYPE_E ToHiRegionType(RegionType type) {
  switch (type) {
    case RegionType::kOverlay:    return OVERLAY_RGN;
    case RegionType::kOverlayEx:  return OVERLAYEX_RGN;
    case RegionType::kCover:      return COVER_RGN;
    case RegionType::kCoverEx:    return COVEREX_RGN;
    case RegionType::kMosaic:     return MOSAIC_RGN;
  }
  return OVERLAY_RGN;
}
...
MOD_ID_E ToHiModule(MppModule module) {
  switch (module) {
    case MppModule::kVi:   return HI_ID_VI;
    case MppModule::kVpss: return HI_ID_VPSS;
    case MppModule::kVenc: return HI_ID_VENC;
    case MppModule::kVo:   return HI_ID_VO;
  }
  return HI_ID_VENC;
}
